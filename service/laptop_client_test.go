...
func TestClientCreateLaptop(t *testing.T) {
	...
	laptopServer, serverAddress := startTestLaptopServer(t, laptopStore, imageStore, nil)
...
func startTestLaptopServer(t *testing.T, store service.LaptopStore, imageStore service.ImageStore, ratingStore service.RatingStore) (*service.LaptopServer, string) {
