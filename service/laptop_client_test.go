...
func TestClientCreateLaptop(t *testing.T) {
	...
	laptopServer, serverAddress := startTestLaptopServer(t, laptopStore, imageStore)
...
func startTestLaptopServer(t *testing.T, store service.LaptopStore, imageStore service.ImageStore) (*service.LaptopServer, string) {
